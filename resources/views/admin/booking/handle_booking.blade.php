...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Đặt phòng/</span> Danh sách xử lý đặt phòng</h4>

      <div class="card">
        <h5 class="card-header">Danh sách xử lý đặt phòng</h5>
            ...
            <tbody class="table-border-bottom-0">
              @if ($bookingRooms)
                ...
                <tr>
                  ...
                  <td><i class="fab fa-angular fa-lg text-danger me-3"></i>{{$bookingRoom->booking_id}}</td>
                  <td>
                    <x-booking-status routeDetail="" acceptBooking="{{route('bookings.acceptBooking', ['booking' => $bookingRoom->uuid])}}" acceptBookingAttr="" cancelBooking="{{route('bookings.cancelBooking', ['booking' => $bookingRoom->uuid])}}"/>
                  </td>
                </tr> 
                @endforeach
              @endif    
