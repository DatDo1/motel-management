...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__language">
            <img src="client/img/lan.png" alt="">
            <span>English</span>
                ...
                <div class="col-lg-6">
                    <div class="home__about__text">
                        ...
                        <p class="last-para">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                            doloremque.</p>
                        <img src="client/img/home-about/sign.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="home__about__pic">
                        <img src="client/img/home-about/home-about.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="services__item">
                        <img src="client/img/services/services-1.png" alt="">
                        <h4>Free Wi-Fi</h4>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="services__item">
                        <img src="client/img/services/services-2.png" alt="">
                        <h4>Premium Pool</h4>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="services__item">
                        <img src="client/img/services/services-3.png" alt="">
                        <h4>Coffee Maker</h4>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="services__item">
                        <img src="client/img/services/services-4.png" alt="">
                        <h4>Bar Wine</h4>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="services__item">
                        <img src="client/img/services/services-5.png" alt="">
                        <h4>TV HD</h4>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="services__item">
                        <img src="client/img/services/services-6.png" alt="">
                        <h4>Restaurant</h4>
    ...
    <section class="home-room spad">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-6 col-sm-6 p-0 m-5">
                    <div class="home__room__item set-bg" data-setbg="client/img/home-room/hr-1.jpg">
                ...
                <div class="col-lg-2 col-md-6 col-sm-6 p-0 m-5">
                    <div class="home__room__item set-bg" data-setbg="client/img/home-room/hr-2.jpg">
                        <div class="home__room__title">
                            <h4>Deluxe Room</h4>
                ...
                <div class="col-lg-2 col-md-6 col-sm-6 p-0 m-5">
                    <div class="home__room__item set-bg" data-setbg="client/img/home-room/hr-3.jpg">
                        <div class="home__room__title">
                            <h4>Deluxe Room</h4>
                ...
                <div class="col-lg-2 col-md-6 col-sm-6 p-0 m-5">
                    <div class="home__room__item set-bg" data-setbg="client/img/home-room/hr-4.jpg">
                        <div class="home__room__title">
                            <h4>Deluxe Room</h4>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="testimonial__pic">
                        <img src="client/img/testimonial-left.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-7">
    ...
    {{-- <div class="chooseus spad set-bg" data-setbg="client/img/chooseus-bg.jpg">
        <div class="container">
    ...
    {{-- <section class="gallery spad">
        ...
        <div class="gallery__slider owl-carousel">
            <div class="gallery__item small__item set-bg" data-setbg="client/img/gallery/gallery-1.jpg"></div>
            <div class="gallery__item set-bg" data-setbg="client/img/gallery/gallery-2.jpg"></div>
            <div class="gallery__item set-bg" data-setbg="client/img/gallery/gallery-3.jpg"></div>
            <div class="gallery__item set-bg" data-setbg="client/img/gallery/gallery-4.jpg"></div>
        </div>
    </section> --}}
    <!-- Gallery Section End -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 p-0 order-lg-1 col-md-6 order-md-1">
                    <div class="latest__blog__pic set-bg" data-setbg="client/img/latest-blog/lb-1.jpg"></div>
                </div>
                ...
                <div class="col-lg-3 p-0 order-lg-3 col-md-6 order-md-4">
                    <div class="latest__blog__pic set-bg" data-setbg="client/img/latest-blog/lb-2.jpg"></div>
                </div>
                ...
                <div class="col-lg-3 p-0 order-lg-6 col-md-6 order-md-5">
                    <div class="latest__blog__pic latest__blog__pic__last__row set-bg"
                        data-setbg="client/img/latest-blog/lb-3.jpg"></div>
                </div>
                ...
                <div class="col-lg-3 p-0 order-lg-8 col-md-6 order-md-8">
                    <div class="latest__blog__pic latest__blog__pic__last__row set-bg"
                        data-setbg="client/img/latest-blog/lb-4.jpg"></div>
                </div>
    ...
    <footer class="footer set-bg" data-setbg="client/img/footer-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="logo__carousel owl-carousel">
                        <div class="logo__carousel__item">
                            <a href="#"><img src="client/img/logo/logo-1.png" alt=""></a>
                        </div>
                        <div class="logo__carousel__item">
                            <a href="#"><img src="client/img/logo/logo-2.png" alt=""></a>
                        </div>
                        <div class="logo__carousel__item">
                            <a href="#"><img src="client/img/logo/logo-3.png" alt=""></a>
                        </div>
                        <div class="logo__carousel__item">
                            <a href="#"><img src="client/img/logo/logo-4.png" alt=""></a>
                        </div>
                        <div class="logo__carousel__item">
                            <a href="#"><img src="client/img/logo/logo-5.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
